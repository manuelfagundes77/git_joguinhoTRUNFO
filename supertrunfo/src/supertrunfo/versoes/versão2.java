...
public class versão2 {
     ...
     *            1 - O jogo esta distribuindo as cartas igualmente para o jogador é PC.
     *            2 - O jogo esta ganhando ou perdendo a carta depois da comparação.
     *            3 - O Jogo so Acabara quando o jogador ou pc estiverem sem cartas.
     *            4 - Precisa ser implementado Metodo para caso OCORRA EMPATE.
     *            5 - Precisa ser implementado Metodo para que caso o jogador perca, a maquina escolha o melhor atributo da proxima,
     *              Carta dela. (uma comparação entre todos os atributos int? e pegar o maior? )
     */            
    public static void main(String[] args) {
        ...
        // FOR para escolha aleatoria de cartas dentro do baralho criado, ira escolher a metade e retirar elas do baralho e mandar para o baralho
        //do jogador
        for (int i = 1; i < tamanhoDoBaralho; i++) {
            ...
            pokemon jogadorCarta = baralho2.getCartaBaralho(jogador);// pegando carta do baralho e colocando ela em nova variavel
            ...
            if (atributo.equals("ataque")) {
                if (jogadorCarta.getAtaque() > pcCarta.getAtaque()) {
                    ...
                    if(contadorDeEmpate != 0){
                        ...
                        contadorDeEmpate = 0;
                        System.out.println("voce ganhou todas as cartas do empate. qunatidade de cartas obitidas :" +  barahoDeEmpate.size());
                ...
                if (jogadorCarta.getAtaque() < pcCarta.getAtaque()) { 
                    ...
                    if(contadorDeEmpate != 0){
                        ...
                        contadorDeEmpate =0;
                        System.out.println("O PC ganhou todas as cartas do empate. qunatidade de cartas obitidas :" +  barahoDeEmpate.size());
                        barahoDeEmpate.clear();
                        System.out.println("TESTE numero de cartas no empate baralho" + barahoDeEmpate.size());
                        System.out.println("todas minhas cartas");
